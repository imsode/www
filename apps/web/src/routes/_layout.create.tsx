...
function CreatePage() {
	...
	return (
		<div className="flex flex-col min-h-full bg-neutral-50 pb-[3.5rem] sm:pb-0">
			<div className="flex-1 container max-w-3xl mx-auto p-4 pb-24">
				...
				{step === "template" && (
					<div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
						...
						<div className="fixed bottom-[calc(3.5rem+env(safe-area-inset-bottom))] sm:bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-100 z-10 flex justify-center sm:mb-0">
							<Button
