...
export function StepFooter({ children }: { children: React.ReactNode }) {
	return (
		<div className="fixed bottom-0 left-0 right-0 p-4 pb-[calc(1rem+env(safe-area-inset-bottom))] bg-white/80 backdrop-blur-md border-t border-gray-100 z-[60] flex justify-center items-center w-full shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
